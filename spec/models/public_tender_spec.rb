...
describe PublicTender do
  describe "#validate public tenders?" do
    it "Should be valid public tender" do
      public_tender0 = PublicTender.new(department: "SEDU", document_number: "9/2016", code: "61828450844")
      expect(public_tender0.valid?).to eq(true)
    end
    it "Should be invalid public tender" do
      public_tender0 = PublicTender.new(department: "SEDU", document_number: "9/2016", code: "61828450843")
      expect(public_tender0.valid?).to eq(false)
