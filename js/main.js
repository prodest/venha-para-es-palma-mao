                ...
                $.get("dados/arq_json/candidatos.json", {  }, function(data){
                    ...
                    if(CPF_Clean.length < 11) {
                        ...
                        if (!achou) {
                            ...
                            $("#tabela").append("<table id = \"tableSorter\" border=\"1\"><thead><tr><th>Orgão</th><th>Cód. Concurso</th><th>Edital</th></tr></thead><tbody></tbody></table>");
                            $.get("dados/arq_json/concursos.json", {  }, function(data_conc){
                                ...
                                if (verficaCod.length == 0) {
                                    $("#tabela").empty();
                                    $("#tabela").append("<table border=\"1\"><tbody><tr><td>Não existem concursos destinados ao perfil desse candidato.</td></tr></tbody></table>");
                                }
                            }, "json");
                            $('html, body').animate({
                ...
                $.get("dados/arq_json/concursos.json", {  }, function(data){
                    ...
                    if (cod_Clean.length == 0) {
                        ...
                        if (!achou) {
                            ...
                            $("#tabela").append("<table class=\"tablesorter\" border=\"1\"><thead><tr><th class = \"header\">Nome</th><th class = \"header\">Dt. de Nasc.</th><th class = \"header\">CPF</th></tr></thead><tbody></tbody></table>");
                            $.get("dados/arq_json/candidatos.json", {  }, function(data_cand){
                                ...
                                if (verificaCPF.length == 0) {
                                    $("#tabela").empty();
                                    $("#tabela").append("<table border=\"1\"><tbody><tr><td>Não existem candidatos com perfil para esse concurso.</td></tr></tbody></table>");
                                }
                            }, "json");
                            $('html, body').animate({
                                scrollTop: $("#tabela").offset().top
